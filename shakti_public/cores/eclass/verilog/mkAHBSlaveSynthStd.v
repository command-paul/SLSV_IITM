...
//
// On Tue Jun 20 18:41:01 IST 2017
//
//
// Ports:
// Name                         I/O  size props
...
module mkAHBSlaveSynthStd(CLK,
  ...
  assign MUX_ifc_response_wire$wset_1__VAL_1 =
	     { 2'd0, fifo_rx_rv$port1__read[55:24], 2'd0 } ;
  ...
  begin
    if (RST_N == `BSV_RESET_VALUE)
      begin
        ctrl_reg <= `BSV_ASSIGNMENT_DELAY 46'h0AAAAAAAAAAA;
	fifo_op_rv <= `BSV_ASSIGNMENT_DELAY 1'd0;
	fifo_rx_rv <= `BSV_ASSIGNMENT_DELAY 59'h2AAAAAAAAAAAAAA;
	fifo_tx_rv <= `BSV_ASSIGNMENT_DELAY 111'h2AAAAAAAAAAAAAAAAAAAAAAAAAAA;
