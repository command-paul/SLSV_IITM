...
//
// On Tue Jun 20 18:40:59 IST 2017
//
//
// Ports:
// Name                         I/O  size props
...
module mkAHBMasterStd(CLK,
  ...
  wire [32 : 0] MUX_data_reg$write_1__VAL_2, MUX_data_reg$write_1__VAL_3;
  ...
  assign MUX_ifc_fifo_op_q_1$write_1__VAL_2 =
	     (ifc_fifo_op_cntr_r == 2'd2) ? ifc_fifo_op_x_wire$wget : 2'd0 ;
  ...
  begin
    case (1'b1) // synopsys parallel_case
      WILL_FIRE_RL_idle_op: data_reg$D_IN = 33'h0AAAAAAAA;
  ...
  begin
    case (1'b1) // synopsys parallel_case
      ...
      WILL_FIRE_RL_ifc_fifo_op_decCtr: ifc_fifo_op_q_1$D_IN = 2'd0;
  ...
  begin
	...
	data_reg <= `BSV_ASSIGNMENT_DELAY 33'h0AAAAAAAA;
	descriptor <= `BSV_ASSIGNMENT_DELAY 110'h0AAAAAAAAAAAAAAAAAAAAAAAAAAA;
	fifo_rx_rv <= `BSV_ASSIGNMENT_DELAY 111'h2AAAAAAAAAAAAAAAAAAAAAAAAAAA;
	fifo_tx_count <= `BSV_ASSIGNMENT_DELAY 3'd0;
	grant_reg <= `BSV_ASSIGNMENT_DELAY 1'd0;
	ifc_fifo_op_cntr_r <= `BSV_ASSIGNMENT_DELAY 2'd0;
	ifc_fifo_op_q_0 <= `BSV_ASSIGNMENT_DELAY 2'd0;
	ifc_fifo_op_q_1 <= `BSV_ASSIGNMENT_DELAY 2'd0;
