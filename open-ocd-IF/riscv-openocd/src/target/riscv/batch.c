...
void riscv_batch_add_nop(struct riscv_batch *batch)
{
	...
	printf("  added NOP with in_value=0x%p\n", field->in_value);
}

void dump_field(const struct scan_field *field)
{
	printf(">>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>   Called dump field \n");
