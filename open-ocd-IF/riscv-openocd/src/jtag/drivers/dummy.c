...
static uint32_t bit_count = 0xFFFFFFFF;

static int dummy_read(void)
{
	int data = 1 & dummy_data;
	int a= 0;
	printf("Dummy Read Called %d\n",a);
	if(bit_count==0){
		a = scanf("%u\n",&dummy_data);
		bit_count = 0xFFFFFFFF;
	}
